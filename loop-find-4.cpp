      ...
      if ((e==0)&&(rValue.find('for') != std::string::npos)){ //no rvalue or body to print out
        ...
        break;
          ...
          //  cout<<checkForOp<<endl;
            if ((checkForOp.find('+') != std::string::npos) || (checkForOp.find('-') != std::string::npos)||(checkForOp.find('*') != std::string::npos)||(checkForOp.find('/') != std::string::npos)){
...
printf("-------------------rValue------------------\n");
      ...
      if ((e==0)&&(rValue.find('for') != std::string::npos)){ //no rvalue or body to print out
        ...
        checkIVal = rValue.back();
         ...
         printf("-------------------While-------------------\n");
         cout<<"W"<<endl;
         if(CondVar == NULL){cout<<"NULL"<<endl;} else{cout<<CondVar->getNameAsString()<<endl;}
         cout<<CondVal<<endl;
...
//    While Loop Matcher
      ...
      whileStmt(
       ...
       hasBody(stmt().bind("whileLoopBody")
          )
